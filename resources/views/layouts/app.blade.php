                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('clients') }}">{{ __('Clientes') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('products') }}">{{ __('Productos') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('client-assignuser-i') }}">{{ __('Asignación') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('sales') }}">{{ __('Ventas') }}</a>
                            </li>
