            ...
            <div id="home" class="container tab-pane active"><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 pull-right">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="<?php echo e($buscado); ?>" name="search-name" placeholder="Buscar producto" id="search-name"/>
                        ...
                        <div class="col-lg-4">
                            ...
                            <a href="<?php echo e(route('product-create')); ?>" class="btn btn-success">
                                Registrar producto
                            </a>
                        </div>
                    </div>
                ...
                <table class="table table-hover">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="item-row<?php echo e($product->id_product); ?>">
                            <th scope="row"><?php echo e($product->id_product); ?></th>
                            <td><?php echo e($product->product_name); ?></td>
                            <td><?php echo e($product->sale_price); ?></td>
                            <td class="text-center"><?php echo e($product->stock); ?></td>
                            <td class="text-center"><?php echo e($product->client_productsCount); ?></td>
                            <td><?php echo e($product->product_created_at); ?></td>
                            <td class="text-center" style="width: 20%;">
                                <a href="<?php echo e(route('product-edit', ['id' => $product->id_product])); ?>" class="table-link">
                                    <span class="fa-stack">
                                ...
                                <a class="btn-product-delete" data-id="<?php echo e($product->id_product); ?>" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pruebas_laborales/Eadvising_20012021/eadvising_laravel/resources/views/products/index.blade.php ENDPATH**/ ?>