                    ...
                    <?php if( $clients->count() > 0 ): ?>
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="item-row<?php echo e($client->id_client); ?>">
                                ...
                                <td class="btn-outline-info"><?php echo e($client->names); ?></td>
                                ...
                                <td class="text-center" style="width: 20%;">
                                    ...
                                    <a data-toggle="modal"
                                        ...
                                        data-name="<?php echo e($client->first_name_cli. ' ' .$client->sur_name_cli. ' ' .$client->business_name_cli); ?> "
                                        data-id="<?php echo e($client->id_client); ?>">
                                        <i class="fas fa-tasks"></i>Asignar
                                    </a>

                                    <a class="btn-delete-assign btn btn-outline-danger" data-id="<?php echo e($client->id_client); ?>" >
                ...
                <div class="modal-body" >
                    ...
                    <div class="card-footer">
                        <div class="row justify-content-center">
                            ...
                            <a href="<?php echo e(route('client-assignuser-i')); ?>" class="btn btn-default">
                                Cancelar
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pruebas_laborales/Eadvising_20012021/eadvising_laravel/resources/views/asign/index.blade.php ENDPATH**/ ?>